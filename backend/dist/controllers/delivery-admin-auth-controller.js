...
function signDeliveryAdminToken(user) {
    return jwt.sign({
        sub: user.id,
        username: user.username,
        email: user.email,
        aud: "delivery_admin",
    }, env.jwtSecretDeliveryAdmin, { expiresIn: "8h" });
}
...
export async function getDeliveryAdminMe(req, res) {
    try {
...
//# sourceMappingURL=delivery-admin-auth-controller.js.map